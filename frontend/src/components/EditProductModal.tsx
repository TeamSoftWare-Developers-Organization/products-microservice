    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="outline" size="sm" className="gap-1.5 border-border hover:bg-accent text-foreground">
            ...
            <DialogContent className="sm:max-w-[480px] max-h-[90vh] overflow-y-auto border border-border/50 bg-card/95 backdrop-blur-md text-foreground" dir={dir}>
                <DialogHeader>
                    <DialogTitle className="text-xl font-bold">{t("editProductTitle")}</DialogTitle>
