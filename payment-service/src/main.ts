...
async function bootstrap() {
  ...
  const queueName = Buffer.from('cGF5bWVudF9zZXJ2aWNlX3F1ZXVl', 'base64').toString('utf8');
  ...
  console.log(`[Payment Service] RabbitMQ Microservice connected to: ${process.env.RABBITMQ_URL || defaultRmqUrl}`);
}
bootstrap();
